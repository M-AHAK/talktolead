               ...
               <div class="col-md-12">
                  <div class="grid2 b-access-pdfv">
                     ...
                     <div class="b-access-pdftext">
                        <h1>Key issues </h1>
                        <ul>
                           <li><i class="mdi mdi-arrow-top-right"></i> Resource Constraints and Audience Diversity</li>
                           <li><i class="mdi mdi-arrow-top-right"></i>Limited Budgets</li>
                           <li><i class="mdi mdi-arrow-top-right"></i>Privacy and Data Security</li>
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="s-tabsClick">
                     <ul class="">
                        <li class="list active"><a href="https://www.talk2lead.com/smo/education/#education" class="onboarding">Educational</a></li>
                        <li class="list"><a href="https://www.talk2lead.com/smo/education/#studyabroad" class="studyabroad">Online Learning</a></li>
                        <li class="list"><a href="https://www.talk2lead.com/smo/education/#edTech" class="edTech">Educational  </a></li>
                        <li class="list"><a href="https://www.talk2lead.com/smo/education/#training" class="training">Language Schools </a></li> 
                        <li class="list"><a href="https://www.talk2lead.com/smo/education/#k12" class="quality">Preparation</a></li> 
                        <li class="list"><a href="https://www.talk2lead.com/smo/education/#test" class="test">Tutoring</a></li>  
                         <li class="list"><a href="https://www.talk2lead.com/smo/education/#consultants" class="educational">Development</a></li> 
                        <li class="list"><a href="https://www.talk2lead.com/smo/education/#publishers" class="publishers">Events</a></li>  
                     </ul>
                  </div>
               </div>
            </div>
                  ...
                  <div class="acc-impro-bg">
                     ...
                     <div class="acc-impro-text">
                       <h3>Online Learning Platforms </h3>  
                        <p>Boost visibility for e-learning platforms, reaching students seeking online courses and educational resources. </p> 
                     </div>
                  </div>
               </div>
               ...
               <div class="col-md-12 choose-acade-sec samenv1" id="training">
                  <div class="acc-impro-bg">
                     ...
                     <div class="acc-impro-text">
                        ...
                        <p>Optimize social media platforms for language schools, attracting learners interested in language courses. </p> 
                     </div>
                  </div>
               </div>
               <div class="col-md-12 acc-impro-sec samenv1" id="k12">
                  <div class="acc-impro-bg">
                     <div class="acc-impro-text">
                        ...
                        <p>Target students looking for test prep services and resources, ensuring increased engagement. </p>
               ...
               <div class="col-md-12 choose-acade-sec samenv1" id="test">
                  <div class="acc-impro-bg">
                     ...
                     <div class="acc-impro-text">
                        ...
                        <p>Amplify the reach of tutoring services, connecting tutors with students seeking personalized help. </p>
               ...
               <div class="col-md-12 choose-acade-sec samenv1" id="publishers">
                  <div class="acc-impro-bg">
                     ...
                     <div class="acc-impro-text">
                        ...
                        <p>Create awareness for seminars, workshops, and conferences within the education sector.</p> 
